...
#+ATTR_HTML: :alt Screenshot of neovim with nvim-tree open and git decorations :title Screenshot of neovim with nvim-tree open and git decorations
[[../../../screenshots/nvim_thumb.png]]

#+CAPTION: Screenshot of neovim with highlighted colors, git decorations and a buffer bar shown
#+ATTR_HTML: :alt Screenshot of neovim with highlighted colors, git decorations and a buffer bar shown :title Screenshot of neovim with highlighted colors, git decorations and a buffer bar shown
