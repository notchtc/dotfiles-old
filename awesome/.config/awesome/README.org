...
#+ATTR_HTML: :alt Screenshot of Awesome with no windows open :title Screenshot of Awesome with no windows open :align center :width 825
#+ATTR_ORG: :width 825
[[../../../screenshots/Awesome_idle_thumb.png]]

#+CAPTION: Screenshot of Awesome with emacs, nvim and a terminal open
#+ATTR_HTML: :alt Screenshot of Awesome with emacs, nvim and a terminal open :title Screenshot of Awesome with emacs, nvim and a terminal open :align center :width 825
#+ATTR_ORG: :width 825
[[../../../screenshots/Awesome_busy_thumb.png]]

#+CAPTION: Screenshot of Awesome with every window minimized except emacs
#+ATTR_HTML: :alt Screenshot of Awesome with every window minimized except emacs :title Screenshot of Awesome with every window minimized except emacs :align center :width 825
#+ATTR_ORG: :width 825
...
| alacritty  | Terminal[fn:1]                                                                |
| pamixer    | Change volume[fn:2]                                                           |
| firefox    | Browser[fn:1]                                                                 |
| maim       | Screenshot tool[fn:1]                                                         |
| lollypop   | Music player[fn:1]                                                            |
| newsboat   | RSS reader[fn:1]                                                              |
| playerctl  | Control media players                                                         |
| rofi       | Application launcher (and also a dmenu replacement and window switcher)[fn:1] |
| xbacklight | Control screen brightness[fn:2]                                               |

[fn:1] You can change this in [[./settings/vars.lua][settings/vars.lua]].
[fn:2] You can change this in [[./settings/keys.lua][settings/keys.lua]].

** Autostart
There are some things launched at start in [[./autostart.lua][autostart.lua]].

You probably want to add/remove/change some stuff here.[fn:3] If you want to remove the autostart completely, just remove/comment out the require line in rc.lua and delete the file if you want.
...
[fn:3] If you want to remove the autostart completely, just remove/comment out the require line in [[./rc.lua][rc.lua]] and delete the file if you want.

* Keybindings
When using Awesome you can just do Super+S.

#+CAPTION: Screenshot of Awesome keybindings
#+ATTR_HTML: :alt Screenshot of Awesome keybindings :title Screenshot of Awesome keybindings :align center :width 825
#+ATTR_ORG: :width 825
