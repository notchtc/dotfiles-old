# Generated by Powerlevel10k configuration wizard on 2020-04-18 at 15:58 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{red}%n%F{green}@%F{yellow}%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%F{red}%n%F{green}@%F{cyan}%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{red}%n%F{yellow}@%F{cyan}%m'
